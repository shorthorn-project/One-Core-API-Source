@ stdcall -stub BreakRecordsIntoBlob(ptr ptr long)
@ stdcall -stub CombineRecordsInBlob(ptr ptr)
...
@ stdcall DnsApiAllocZero(long)
@ stdcall DnsApiFree(ptr)
@ stdcall DnsApiHeapReset()
@ stdcall -stub DnsApiRealloc(ptr long)
@ stdcall -stub DnsApiSetDebugGlobals(ptr ptr)
@ stdcall -stub Dns_AddRecordsToMessage(ptr long long)
@ stdcall -stub Dns_AllocateMsgBuf(long)
@ stdcall -stub Dns_BuildPacket(ptr long wstr long ptr long long)
@ stdcall -stub Dns_CacheSocketCleanup()
@ stdcall -stub Dns_CacheSocketInit(long)
@ stdcall -stub Dns_CleanupWinsock()
@ stdcall -stub Dns_CloseConnection(long)
; @ stdcall -stub Dns_CloseHostFile(ptr)
; @ stdcall -stub Dns_CloseSocket(long)
; @ stdcall -stub Dns_CreateMulticastSocket(long long long long long)
; @ stdcall -stub Dns_CreateSocket(long long long)
; @ stdcall -stub Dns_CreateSocketEx(long long long long long)
; @ stdcall -stub Dns_FindAuthoritativeZoneLib(wstr long ptr ptr)
...
; @ stdcall DnsAddRecordSet_A(ptr ptr ptr)
...
; @ stdcall -stub DnsFreeConfigStructure(ptr long)
